...
| 4 | Dev (proposal, not started) | Make kpfk-archive and kpfk-podcast skip-and-count one bad record like Discovery, instead of failing the whole catalog. With a test that feeds one malformed upload item |
...
| 6 | Paul (decide) | When QIR lags, should Discovery show Pacifica-feed episodes marked "transcript pending"? Today it shows only processed episodes (decision 2026-09-24) |
