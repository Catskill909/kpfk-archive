...
Development is authorized and underway in `/Users/paulhenshaw/Desktop/kpfk-archive`, branch `kpfk-json`. The WBAI runtime and data remain separate. KPFK runs locally on port 8081 with its own persisted instance identity.

### Implemented and verified

- Independent copy, explicit station profile, separate storage and browser preferences; reject missing profile and foreign station data.
